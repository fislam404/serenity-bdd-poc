...
public class Analyzer_POC_StepDefinition {
  ...
  public void admin_adds_fields_by_drag_and_drop(String whereToDnd, String whichFieldToDnd) {
    ...
    //analyzerReportPage.dragDropFieldInRows( "Country" );
    //analyzerReportPage.dragDropFieldInMeasures( "Quantity" );
    //analyzerReportPage.dragDropFieldInRows( "Territory" );
  }

  @Step
  @Then("^Admin should see the fields added to Analyzer rport$")
  public void admin_should_see_the_fields_added_to_Analyzer_rport(List<String> rowHeaderName, List<String> columnHeaderName) {
